...
def find_qt5_paths():
    ...
    qt_candidates = [
        ...
        r"D:\Qt\5.15.2\msvc2019_64",
        r"E:\Qt\5.15.2\msvc2019_64",
        r"E:\Qt\5.15.0\msvc2019_64",
        "/usr/include/qt5",
...
def find_boost_path():
    ...
    boost_candidates = [
        ...
        os.environ.get("BOOST_ROOT_1_83_0"),
        os.environ.get("BOOST_ROOT_1_82_0"),
        os.environ.get("BOOST_ROOT_1_81_0"),
        os.environ.get("BOOST_ROOT_1_80_0"),
        os.environ.get("BOOST_ROOT_1_79_0"),
        r"C:\boost",
        r"C:\boost-1.83.0",
        r"C:\boost_1_83_0",
        r"C:\boost-1.82.0",
